...
class JuegoService {
    static guardarPuntuacion(usuarioId, puntuacion) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield UsuarioRepository_1.default.guardarPuntuacion(usuarioId, puntuacion);
            console;
        });
    }
    static obtenerTops() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield UsuarioRepository_1.default.ObtenerTops();
        });
    }
}
exports.default = JuegoService;
